...
#Region "Guardar Articulo nuevo"
            ...
            Dim _Nuevo As New Articulo With
                ...
                .valor_articulo = If(txtValArticulo.Text = String.Empty, Nothing, Convert.ToDouble(txtValArticulo.Text)),
                .valor_asegurado = If(txtValAsegurado.Text = String.Empty, Nothing, Convert.ToDouble(txtValAsegurado.Text)),
                .valoracion_stock = If((txtValArticulo.Text = String.Empty And txtStockFisico.Text = String.Empty), Nothing, (Convert.ToDouble(txtValArticulo.Text) * Convert.ToDouble(txtStockFisico.Text))),
                .valoracion_seguro = If((txtValAsegurado.Text = String.Empty And txtStockFisico.Text = String.Empty), Nothing, (Convert.ToDouble(txtValAsegurado.Text) * Convert.ToDouble(txtStockFisico.Text))),
                .peso = If(txtPeso.Text = String.Empty, Nothing, Convert.ToDouble(txtPeso.Text)),
                .alto = If(txtAlto.Text = String.Empty, Nothing, Convert.ToDouble(txtAlto.Text)),
                .largo = If(txtLargo.Text = String.Empty, Nothing, Convert.ToDouble(txtLargo.Text)),
                .ancho = If(txtAncho.Text = String.Empty, Nothing, Convert.ToDouble(txtAncho.Text)),
                .coeficiente_volumetrico = If(txtCoefVol.Text = String.Empty, Nothing, Convert.ToDouble(txtCoefVol.Text)),
                .cubicaje = M3,
                ...
                .stock_fisico = If(txtStockFisico.Text = String.Empty, Nothing, txtStockFisico.Text),
                .stock_minimo = If(txtStockMinimo.Text = String.Empty, Nothing, txtStockMinimo.Text),
