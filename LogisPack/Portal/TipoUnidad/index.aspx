<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="index.aspx.vb" Inherits="LogisPack.index2" %>
    ...
    <asp:updatepanel id="updatePanelPrinicpal" runat="server">
        <ContentTemplate>
            ...
            <div class="page-header">
                <h1 class="text-center">Tipo de Unidad</h1>
            </div>
                        ...
                        <asp:GridView id="GridView1" class="table table-bordered table-hover dataTable" runat="server" 
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Id Categoria" Visible="false" HeaderStyle-CssClass="text-center">
                                    <ItemTemplate><asp:Label id="id" runat="server" Text='<%# Eval("id_tipo_unidad") %>'/></ItemTemplate>
                                </asp:TemplateField>
